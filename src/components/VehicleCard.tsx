...
function VehicleCard(props: CarData) {
    ...
    return (
        <div className="card bg-white border-4 border-black my-3 md:w-[45%] lg:w-[90%] lg:shadow-2xl">
            ...
            <a href={`/checkout?vehicleId=${props.vehicleId}&vehicleModelId=${props.vehicleModelId}`} className="pl-2 underline hover:text-sky-700">{props.availability ? "Checkout" : "Schedule Ahead"}</a>
